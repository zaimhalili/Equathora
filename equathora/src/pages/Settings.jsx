        ...
        <div >
            ...
            <main className='min-h-screen flex flex-col gap-5 xl:gap-8 bg-[linear-gradient(180deg,var(--mid-main-secondary),var(--main-color)50%)] items-center text-[var(--secondary-color)] px-8 sm:px-12 md:px-20 lg:px-30 xl:px-72'>
                ...
                <section className='bg-white shadow-gray-500 shadow-2xl rounded-xl w-full px-5 pt-3 pb-5 max-w-[800px]'>
                    ...
                    <div>
                        <div className='w-full flex flex-col gap-2 pb-3'>
                            ...
                            <select
                                ...
                                className="text-md cursor-poSansation px-3 py-2 lg:py-4 border rounded-lg border-[var(--french-gray)] appearance-none bg-white pr-10"
                                style={{
                    ...
                    <hr className='pb-3' />
                    <button type="submit" className='cursor-poSansation py-2 px-3 bg-[var(--accent-color)] text-white font-bold text-md rounded-lg shadow-md shadow-gray-400 border-1 border-black hover:bg-[var(--dark-accent-color)] transition-all duration-150 max-w-[180px]'>Save profile data</button>
                </section>
                ...
                <section className='bg-white shadow-gray-500 shadow-2xl rounded-xl w-full px-5 pt-3 pb-5 flex flex-col gap-2 lg:gap-4 max-w-[800px]'>
                    ...
                    <div>
                        <button type="submit" className='cursor-poSansation py-2 px-3 bg-[var(--accent-color)] text-white font-bold text-md rounded-lg shadow-md shadow-gray-400 border-1 border-black hover:bg-[var(--dark-accent-color)] transition-all duration-150 max-w-[180px]'>Change handle</button>
                    </div>
                </section>
                ...
                <section className='flex gap-4 flex-col lg:flex-row pt-4 pb-7 max-w-[800px]'>
                    ...
                    bg-[var(--really-light-accent)] px-5 py-5 gap-3 flex flex-col shadow-lg shadow-gray-600'>
                        ...
                        <button
                            ...
                            className='cursor-poSansation py-2 px-3 bg-[var(--accent-color)] text-white font-bold text-md border-1 border-black hover:bg-[var(--dark-accent-color)] transition-all rounded-xs duration-200 lg:max-w-[180px] hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed'
                        >
                    ...
                    bg-[var(--really-light-accent)] px-5 py-5 gap-3 flex flex-col shadow-lg shadow-gray-600'>
                        ...
                        <button type="submit" className='cursor-poSansation py-2 px-3 rounded-xs bg-[var(--accent-color)] text-white font-bold text-md border-1 border-black hover:bg-[var(--dark-accent-color)] transition-all duration-200 hover:-translate-y-1 lg:max-w-[180px]'>Delete account</button>
                    </div>
                </section>
            </main>
            <Footer />
