...
const Blog = () => {
    ...
    return (
        <div>
            <FeebackBanner />
            <Navbar />
            <main className='flex bg-[var(--main-color)] font-[Sansation] flex-col w-full items-center'>
                {/* Header Section */}
                <section className='w-full flex flex-col items-center bg-[linear-gradient(180deg,var(--secondary-color),var(--accent-color)110%)] shadow-2xl shadow-black/20 py-12 md:py-16 theme-lock'>
                    <div className='px-[4vw] xl:px-[6vw] w-full max-w-[1500px] flex flex-col items-center'>
                        <h1 className='text-4xl font-bold font-[Sansation] text-white'>
                            Equathora Blog
                        </h1>
                ...
                <section className='w-full flex flex-col items-center py-8'>
                    <article className='px-[4vw] xl:px-[6vw] w-full max-w-[1500px] flex flex-col gap-6'>
                        <h2 className='text-2xl font-bold font-[Sansation] text-[var(--secondary-color)]'>
                            Latest Posts
                        </h2>

                        <div className='flex gap-4 flex-wrap justify-center md:justify-start'>
                            {/* Equathora Briefs Card */}
                            <Link to="/equathora-briefs" className='bg-[var(--white)] rounded-md shadow-[0_10px_10px_rgba(141,153,174,0.3)] py-6 px-6 flex gap-2 flex-col hover:shadow-[0_0_25px_rgba(141,153,174,0.7)] transition-all duration-200 ease-out hover:scale-105 cursor-pointer min-w-50 flex-1 max-w-80'>
                            ...
                            {blogPosts.map(post => (
                                <Link
                                    key={post.id}
                                    to={`/blog/${post.slug}`}
                                    className='bg-[var(--white)] rounded-md shadow-[0_10px_10px_rgba(141,153,174,0.3)] py-3 px-6 flex gap-2 flex-col hover:shadow-[0_0_25px_rgba(141,153,174,0.7)] transition-all duration-200 ease-out hover:scale-105 cursor-pointer min-w-50 flex-1 max-w-80'
                                >
