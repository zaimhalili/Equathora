    ...
    <>
        ...
        <main className="legal-page">
            <div className="legal-content">
                ...
                <h2>Contact Us</h2>
                <p>Questions about cookies? Contact us at <a href="mailto:equathora@mail.tin.computer">equathora@mail.tin.computer</a> or <Link to="/feedback">submit feedback</Link>.</p>
            </div>
        </main>
        <Footer />
    </>
