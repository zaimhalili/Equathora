                        ...
                        <div className='flex w-full gap-4 flex-wrap'>
                            {otherPosts.map(otherPost => (
                                <Link
                                    ...
                                    className='bg-white rounded-md shadow-[0_10px_10px_rgba(141,153,174,0.3)] py-6 px-6 flex gap-2 flex-col hover:shadow-[0_0_25px_rgba(141,153,174,0.7)] transition-all duration-200 ease-out hover:scale-105 cursor-poSansation min-w-50 flex-1 max-w-80'
                                >
                                    <img src={otherPost.thumbnail} alt="" className='rounded-md w-full max-h-40 object-cover' />
                                    <p className='text-md text-left lg:text-lg cursor-poSansation font-[Sansation] text-[var(--secondary-color)] font-bold'>
                                        {otherPost.title}
                                    </p>
