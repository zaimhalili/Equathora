...
const BlogPost = () => {
    ...
    const renderContent = (contentItem, index) => {
        switch (contentItem.type) {
            case 'heading':
                return (
                    <h2 key={index} className='text-xl sm:text-2xl font-bold font-[Inter] pt-2'>
                        {contentItem.text}
                    </h2>
                );
            case 'paragraph':
            ...
            <main className='flex bg-white font-[Inter] flex-col min-h-screen w-full items-center'>
                ...
                <section className='w-full flex flex-col bg-[var(--main-color)] items-center py-4'>
                    <article className='px-[4vw] xl:px-[6vw] w-full max-w-[1500px] pb-6 text-black flex flex-col gap-4'>
                        <h1 className='text-xl sm:text-2xl font-bold font-[Inter] text-black'>Other Posts You Might Like</h1>
