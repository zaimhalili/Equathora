...
import { updateCanonicalUrl, updateSearchMetadata } from "./lib/seoMetadata";
...
const AlgebraPractice = lazy(() => import("./pages/AlgebraPractice"));
...
function PageMetadataUpdater() {
    ...
    useEffect(() => {
        const pageTitles = {
            ...
            '/algebra-practice-problems': 'Algebra Practice Problems by Grade | Equathora',
        ...
        updateSearchMetadata(document, location.pathname);
    }, [location]);
            ...
            <Suspense fallback={<LoadingSpinner />}>
                <div id="main-content" tabIndex={-1} className="outline-none">
                    <Routes>
                        ...
                        <Route path="/algebra-practice-problems" element={<AlgebraPractice />} />
