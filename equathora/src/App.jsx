...
const PolynomialPractice = lazy(() => import("./pages/PolynomialPractice"));
...
function PageMetadataUpdater() {
    ...
    useEffect(() => {
        const pageTitles = {
            ...
            '/polynomial-practice-problems': 'Polynomial Practice Problems - Equathora',
            ...
            <Suspense fallback={<LoadingSpinner />}>
                <div id="main-content" tabIndex={-1} className="outline-none">
                    <Routes>
                        ...
                        <Route path="/polynomial-practice-problems" element={<PolynomialPractice />} />
