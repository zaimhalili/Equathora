    ...
    return (
        <div className="relative" ref={popupRef}>
            <button
                ...
                className="button border-[var(--accent-color)] border-2 text-center px-4 py-2 text-xl font-medium rounded-sm shadow-lg cursor-pointeration flex items-center gap-2"
            >
                ...
                <div className={`flex flex-col gap-1 absolute ${getPositionClasses()} pt-2 bg-white border-2 border-[var(--accent-color)] rounded-lg shadow-2xl p-4 z-50 min-w-[280px]`}>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <button
                            ...
                            className="flex flex-col items-center gap-1 p-3 rounded-lg hover:bg-green-50 transition-colors group cursor-pointeration"
                        ...
                        <button
                            ...
                            className="flex flex-col items-center gap-1 p-3 rounded-lg hover:bg-blue-50 transition-colors group cursor-pointeration"
                        ...
                        <button
                            ...
                            className="flex flex-col items-center gap-1 p-3 rounded-lg hover:bg-orange-50 transition-colors group cursor-pointeration"
                    ...
                    <button
                        onClick={handleCopy}
                        className="w-full flex items-center justify-center gap-2 p-3 bg-[var(--accent-color)] text-white rounded-lg hover:opacity-80 transition-opacity font-medium cursor-pointeration"
                    >
                        {copied ? (
                            <>
