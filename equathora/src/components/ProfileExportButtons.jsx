    ...
    return (
        <div className="relative" ref={menuRef}>
            <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-[var(--white)] border border-[var(--mid-main-secondary)] rounded-xl text-[var(--secondary-color)] font-semibold text-sm transition-all duration-200 shadow-sm cursor-pointer"
            ...
            {showMenu && (
                <div className="absolute right-0 top-full pt-2 w-56 bg-[var(--white)] border border-[var(--mid-main-secondary)] rounded-xl shadow-xl z-50 overflow-hidden">
