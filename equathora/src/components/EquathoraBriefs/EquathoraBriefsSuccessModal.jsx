        ...
        <div className="flex items-center ">
            ...
            <div className="p-8 sm:p-10 ">
                ...
                <button
                    type="button"
                    onClick={onClose}
                    className="px-10 py-3 !bg-[linear-gradient(360deg,var(--accent-color),var(--dark-accent-color))] text-white font-semibold rounded-xl hover:!bg-[linear-gradient(360deg,var(--dark-accent-color),var(--dark-accent-color))] transition-all cursor-pointer active:scale-95"
                >
                    Done
                </button>
            </div>
