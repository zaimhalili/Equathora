...
const Dropdown = ({ label, items, alignRight = false }) => {
    return (
        <div className='relative flex h-[7.5vh] ml-0 z-[1001] group'>
            <button className='bg-transparent text-[var(--secondary-color)] border-none font-[Inter,sans-serif] h-full my-auto w-auto list-none font-semibold text-lg px-3 lg:px-2 hover:text-[var(--accent-color)] transition-colors duration-200'>
