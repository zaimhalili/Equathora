...
const FeedbackBanner = () => {
    return (
        <div className="w-full bg-gradient-to-r from-[var(--accent-color)] to-[var(--dark-accent-color)] text-white py-2 px-4 flex items-center justify-center gap-2 text-xs sm:text-sm  shadow-md sticky top-0 z-40">
