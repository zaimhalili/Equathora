                        ...
                        <ScrollReveal key={idx} direction={feature.direction} delay={feature.delay}>
                            <div className="flex flex-col items-center group">
                                ...
                                <motion.div
                                    ...
                                    transition={{ type: 'spring', stiffness: 300 }}
                                    className="relative flex flex-col bg-[var(--white)] rounded-md border border-[var(--mid-main-secondary)] shadow-lg hover:shadow-2xl duration-300 ease-out p-6 w-full min-h-[160px]"
                                >
