            ...
            <div className="w-full max-w-[1500px] px-[4vw] xl:px-[6vw]">
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <ScrollReveal direction="right" className="lg:w-1/2">
                        ...
                        <p className="text-sm sm:text-xl md:text-2xl font-light text-[var(--secondary-color)]">
                            We provide an interactive platform where learners build <span className="font-bold text-[var(--secondary-color)]">confidence through step-by-step guidance</span>, Sigma AI support, and achievement-based motivation.
                        </p>
